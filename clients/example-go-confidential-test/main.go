...
func authenticate(loginUrl, username, password string, usernameClaim, emailClaim *string, screenshot *[]byte) chromedp.Tasks {
	usernameSelector := `//form[@id="loginForm"]//input[@id="username"]`
	passwordSelector := `//form[@id="loginForm"]//input[@id="password"]`
	return chromedp.Tasks{
		// navigate to the application login page.
		// NB this should redirect the browser to the wso2is
		//    authentication page.
		chromedp.Navigate(loginUrl),
		// authenticate into wso2is.
		...
		// wait for wso2is to redirect back to the application.
		chromedp.WaitVisible(`//th[.="Email"]`),
		chromedp.Text(`//th[.="Email"]/../td`, emailClaim),
		chromedp.Text(`//th[.="Username"]/../td`, usernameClaim),
